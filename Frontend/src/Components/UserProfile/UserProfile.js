...
function UserProfile() {
    ...
    async function submitClick() {
        ...
        if (nameError.innerText === "" && passwordError.innerText === "" && securityCodeError.innerText === "") {
            ...
            await axios.put(`https://recipe-wbww.onrender.com/updateUser?email=${userData.email}&securityCode=${security}`, newPassword)
                .then((res) => {
                    ...
                    async function getUserData() {
                        let passwordInput = '';
                        await axios.get(`https://recipe-wbww.onrender.com/login?email=${email.value}&password=${passwordInput}`)
                            .then((res) => {
